...
/* the project.                                                               */
/*----------------------------------------------------------------------------*/
package com._604robotics.robot2014.utils;
 ...
 * PIDOutput
 */
public class AntiWindupPIDController implements IUtility, LiveWindowSendable {
    ...
    public class PercentageTolerance implements AntiWindupPIDController.Tolerance {
	double percentage;
    ...
    public class AbsoluteTolerance implements AntiWindupPIDController.Tolerance {
	double value;
    ...
    public class NullTolerance implements AntiWindupPIDController.Tolerance {
