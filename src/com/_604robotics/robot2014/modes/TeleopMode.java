    ...
    protected void apply (ModuleManager modules) {
        /* Shared Controls */
        {
            /* Drive */
            {
                ...
                this.bind(new Binding(modules.getModule("Drive").getAction("Kid Friendly Drive"), modules.getModule("Dashboard").getTrigger("Kid Friendly Drive")));
                this.fill(new DataWire(modules.getModule("Drive").getAction("Kid Friendly Drive"), "left", driverXbox.leftStick.Y));
                this.fill(new DataWire(modules.getModule("Drive").getAction("Kid Friendly Drive"), "right", driverXbox.rightStick.Y));

                this.bind(new Binding(modules.getModule("Drive").getAction("Kid Friendlier Drive"), modules.getModule("Dashboard").getTrigger("Kid Friendlier Drive")));
                this.fill(new DataWire(modules.getModule("Drive").getAction("Kid Friendlier Drive"), "left", driverXbox.leftStick.Y));
                this.fill(new DataWire(modules.getModule("Drive").getAction("Kid Friendlier Drive"), "right", driverXbox.rightStick.Y));
            }
        }
